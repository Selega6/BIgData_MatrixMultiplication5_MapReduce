...
t00=time.time()
inputfile = open('../Matrices/Test_sparseA.txt','r+')
linesOfFile=inputfile.readlines()
noOfRows, _,_ = linesOfFile[0].split()

inputfile2 = open('../Matrices/Test_sparseB.txt','r+')
linesOfFile2=inputfile2.readlines()
_, noOfCols,_ = linesOfFile2[0].split()

counter = 0

class MatrixMultiplication(MRJob):

    f = open('../Matrices/OutputMatrix.txt', 'w')
